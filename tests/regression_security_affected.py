...
def client():
    ...
    with patch("app.core.config.settings.API_KEY", SecretStr(TEST_KEY)), \
         patch("app.core.config.settings.ADMIN_API_KEY", SecretStr(TEST_ADMIN_KEY)):
