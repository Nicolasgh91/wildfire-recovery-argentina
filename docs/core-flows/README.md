...
- **Documentos existentes relacionados**:
  ...
  - `docs/archive/ndvi-uf12/uc-f12-as-is-analysis-2026-02-24.md` — **histórico/overview** (estado AS-IS previo a la implementación nueva)
  - `docs/archive/ndvi-uf12/uc-f12-implementation-spec.md` — **design** (especificación de implementación del flujo extendido UC‑F12)
  - `docs/archive/ndvi-uf12/uc-f12-technical-tasks-claude-code.md` — **histórico/design** (lista técnica de tareas, ya ejecutadas en parte)
  - `docs/archive/ndvi-uf12/diagrams/uc-f12-data-flow-diagram-776569.md` — **overview/design** (diagrama extendido de flujo de datos)
  - `docs/archive/endpoints/fires-stats-workflow.md` — **overview** (flujo de cálculo/lectura de estadísticas de incendios)
  - `docs/archive/endpoints/audit-reverse-geocode-workflow.md` — **overview/design** (enriquecimiento geográfico de detecciones/eventos)
  - `docs/archive/endpoints/error-analysis-endpoints.md` — **histórico** (análisis de errores anteriores del flujo)
...
- **Documentos existentes relacionados**:
  - `docs/archive/ndvi-uf12/uc-f12-implementation-spec.md` — **design** (especificación de implementación UC‑F12)
  - `docs/archive/ndvi-uf12/uc-f12-gee-optimization-analysis.md` — **design** (optimización sobre GEE para UC‑F12)
  - `docs/archive/ndvi-uf12/uc-f12-testing-and-manual-workers.md` — **manual/runbook** (tests y ejecución manual de workers UC‑F12)
  - `docs/archive/ndvi-uf12/diagrams/uc-f12-data-flow-diagram-776569.md` — **overview** (flujo completo de datos UC‑F12)
  - `docs/archive/ndvi-uf12/testing/uc-f12-testing-execution-776569.md` — **histórico/manual** (ejecución de pruebas específicas)
...
- **Documentos existentes relacionados**:
  - `docs/archive/endpoints/fires-stats-workflow.md` — **overview** (flujo de stats de incendios consumidas por UI)
...
- **Documentos existentes relacionados**:
  ...
  - `docs/archive/ndvi-uf12/diagrams/uc-f12-data-flow-diagram-776569.md` — **overview** (flujo extendido con UC‑F12)
