...
> Documento de deuda técnica histórica para UI. Las acciones pendientes derivadas de este log deben consolidarse en `docs/tasks/backlog.md` cuando se prioricen.
