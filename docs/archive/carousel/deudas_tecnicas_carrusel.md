# Deudas técnicas — ForestGuard (carrusel y thumbnails)

> Documento de deudas técnicas centrado en el carrusel y flujo de thumbnails. La síntesis de estado vive en `docs/STATE.md`, `docs/features/carousel.md` y `docs/tasks/backlog.md`. Usar este archivo como referencia extendida de contexto histórico y técnico.
