...
> Documento archivado. El estado vigente de producto y documentación se refleja en `docs/STATE.md`, `docs/product/README.md` y `docs/tasks/backlog.md`. Conservar este archivo solo como registro histórico de la ejecución de 2026-02-22.
...
- [x] **P1**
  - archivo objetivo: `docs/archive/assets/status_2026-02-22.md`
