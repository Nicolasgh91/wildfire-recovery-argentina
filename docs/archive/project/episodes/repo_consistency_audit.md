...
> Documento archivado. Auditoría puntual del 2026-02-16 sobre el pipeline detecciones→eventos→episodios, workers Celery y consistencia con la documentación de `episode_creation_flow`.  
> El estado vigente del pipeline está consolidado en `docs/architecture/flows.md`, `docs/core-flows/core-pipeline-e2e/` y `docs/STATE.md`. Usar este archivo solo como referencia histórica de hallazgos y recomendaciones.
