# Uc-f12 vae — technical debt and deviations

> Documento de deuda técnica y desvíos específico de UC-F12. La descripción de feature está en `docs/features/recovery.md` y la auditoría arquitectónica completa en `docs/archive/ndvi-uf12/vae-flow-audit.md`. Usar este archivo como referencia histórica; consolidar nuevas acciones en `docs/tasks/backlog.md`.
