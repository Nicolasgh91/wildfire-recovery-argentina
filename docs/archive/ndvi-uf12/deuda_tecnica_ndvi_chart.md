...
> Documento de deuda técnica específica de NDVI. La visión de feature vive en `docs/features/recovery.md` y la auditoría completa del flujo VAE en `docs/archive/ndvi-uf12/vae-flow-audit.md`. Las acciones pendientes relevantes deben consolidarse en `docs/tasks/backlog.md`.
