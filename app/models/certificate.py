...
class BurnCertificate(Base, UUIDMixin, TimestampMixin):
    ...
    fire_event_id = Column(UUID(as_uuid=True), ForeignKey("fire_events.id"), nullable=False)
    ...
    certificate_number = Column(String, unique=True, nullable=False) # Ej: FG-CERT-2026-00001
