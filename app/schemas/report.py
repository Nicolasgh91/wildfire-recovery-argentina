...
class ReportConfig(BaseModel):
    ...
    post_fire_frequency: PostFireFrequency = Field(
        PostFireFrequency.ANNUAL,
        description="Frecuencia de imágenes post-incendio"
    )
    ...
    include_ndvi_chart: bool = Field(True, description="Incluir gráfico de evolución NDVI")
    max_cloud_cover: float = Field(30.0, ge=0, le=100, description="Máximo % de nubes permitido")
...
class HistoricalReportRequest(BaseModel):
    ...
    protected_area_name: Optional[str] = Field(None, description="Nombre del área protegida")
    ...
    date_range: Optional[DateRange] = Field(
        None, 
        description="Rango de fechas para búsqueda (default: fire_date hasta hoy)"
    )
...
class ReportOutputs(BaseModel):
    ...
    web_viewer_url: Optional[str] = Field(None, description="URL del visor web interactivo")
...
class HistoricalReportResponse(BaseModel):
    ...
    ```json
    {
        ...
        "fire_events_found": 1,
        "outputs": {
            "pdf_url": "https://r2.../reports/historical/RPT-HIST-20250129-A1B2C3.pdf",
    ...
    verification_url: Optional[str] = Field(None, description="URL para verificar autenticidad")
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "images_collected": 8,
                "outputs": {
                    "pdf_url": "https://r2.forestguard.ar/reports/historical/RPT-HIST-20250129-A1B2C3.pdf",
                    ...
                    "images": [
                        {
                            ...
                            "vis_type": "RGB",
                            "thumbnail_url": "https://r2.../thumbnails/...",
